...
export const TravelDocumentsPage: React.FC = () => {
  ...
  const cards: TravelCard[] = [
    { status: 'Approved', title: 'Business Trip Visa Application', author: 'Sarah Johnson', from: 'London', to: 'Tokyo', dates: '15-22 Oct 2023', description: 'Quarterly client meetings with key stakeholders in Tokyo office', modified: 'Modified 2 days ago' },
    { status: 'Pending', title: 'Business Trip Visa Application', author: 'Sarah Johnson', from: 'London', to: 'Tokyo', dates: '15-22 Oct 2023', description: 'Quarterly client meetings with key stakeholders in Tokyo office', modified: 'Modified 2 days ago' },
    { status: 'In Review', title: 'Business Trip Visa Application', author: 'Sarah Johnson', from: 'London', to: 'Tokyo', dates: '15-22 Oct 2023', description: 'Quarterly client meetings with key stakeholders in Tokyo office', modified: 'Modified 2 days ago' },
    { status: 'Approved', title: 'Business Trip Visa Application', author: 'Sarah Johnson', from: 'London', to: 'Tokyo', dates: '15-22 Oct 2023', description: 'Quarterly client meetings with key stakeholders in Tokyo office', modified: 'Modified 2 days ago' },
    { status: 'Pending', title: 'Business Trip Visa Application', author: 'Sarah Johnson', from: 'London', to: 'Tokyo', dates: '15-22 Oct 2023', description: 'Quarterly client meetings with key stakeholders in Tokyo office', modified: 'Modified 2 days ago' },
    { status: 'In Review', title: 'Business Trip Visa Application', author: 'Sarah Johnson', from: 'London', to: 'Tokyo', dates: '15-22 Oct 2023', description: 'Quarterly client meetings with key stakeholders in Tokyo office', modified: 'Modified 2 days ago' },
    { status: 'Approved', title: 'Business Trip Visa Application', author: 'Sarah Johnson', from: 'London', to: 'Tokyo', dates: '15-22 Oct 2023', description: 'Quarterly client meetings with key stakeholders in Tokyo office', modified: 'Modified 2 days ago' },
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      ...
      <div className="flex flex-wrap justify-between items-center gap-3 bg-white p-3.5 rounded-xl border border-slate-200 shadow-xs">
        ...
        <button 
          onClick={() => alert("Add new travel document")}
