...
import { LeaveUsageReportRecord } from '../../../types';
...
export const MyLeaveUsageReportTab: React.FC = () => {
  ...
  const fetchReport = useCallback(async () => {
    setIsLoading(true);
    try {
      const data = await leaveService.getLeaveUsageReport();
      setRecords(data);
    } catch {
...
export default MyLeaveUsageReportTab;
